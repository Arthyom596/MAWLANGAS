...
class Venta:
    ...
    def realizar_venta(self, id_producto, id_sabor, cantidad_str, precio_unitario, nombre_producto, nombre_sabor,usuario):
        ...
        descontar_producto(id_producto, id_sabor, cantidad, fecha,self.usuario)

        # Registrar en VentasDAO
        crear_venta(id_producto, id_sabor, cantidad, fecha,self.usuario)
        ...
        agregar_finanza("Venta", total_venta, descripcion_venta,fecha,self.usuario)
        ...
        agregar_finanza("Inversion", costo_compra, descripcion_inversion,fecha,self.usuario)
