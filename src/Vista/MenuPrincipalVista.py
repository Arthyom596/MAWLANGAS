...
class MenuPrincipal(ctk.CTkFrame):
    def __init__(self, master=None):
        super().__init__(master, fg_color="#87CEEB")  # Azul cielo como fondo real
        self.master = master
        ...
        def crear_boton(texto, color="#3B8ED0", hover="#2F6BA8"):
            return ctk.CTkButton(self, text=texto, font=("Arial", 18, "bold"),
        ...
        self.etiqueta_version = ctk.CTkLabel(self, text="Versión 1.0 • Desarrollado por Arthyom596",
